...
const Page = () => {
    ...
    function extractData(htmlContent) {
        ...
        const oneurlMatch = htmlContent.match(/Url:\s*([^<]+)/i);
        const oneurlMatchN = htmlContent.match(/URL:\s*([^<]+)/i);
